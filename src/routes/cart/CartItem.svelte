...
{#await itemRequest}
<div class="flex w-full h-[170px] items-center justify-center border-b">
...
{:then product}
<div class="flex w-full hover:bg-[#f6f6f6] border-b">
    <div class="flex gap-2 p-3">
        <div class="flex flex-col gap-2 sm:gap-5 h-full w-28 sm:w-40 justify-between">
    ...
    <div class="flex flex-col p-2 justify-between w-full gap-2">
        <div>
            <h1 class="sm:mb-2 font-semibold mb-0 text-lg sm:text-xl">{product.title}</h1>
            <div class="font-semibold mb-1 sm:mb-3">Price: &#8377;&nbsp;{product.price.toFixed(2)}</div>
            <div class="text-sm flex flex-col sm:flex-row gap-0 sm:gap-3">

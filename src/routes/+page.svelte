...
<div class="container px-2 mx-auto flex flex-col sm:flex-row sm:gap-2 items-start">
    <div class="py-2 flex-shrink-0 z-10 w-full sm:w-max md:w-64 sticky top-0 bg-[gainsboro]">
        <details open id="sidebar" class="group p-3 border bg-white rounded">
    ...
    <div class="w-full flex-grow sm:pt-2 pb-2">
        <main class="border p-4 relative bg-white rounded">
